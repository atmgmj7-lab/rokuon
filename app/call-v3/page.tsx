...
type TabType = "main_scenario" | string; // "main_scenario" or situation.id

export default function CallV3Page() {
  ...
  const [dynamicComponents, setDynamicComponents] = useState<ScriptItem[]>([]); // チェック項目で動的追加
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-3 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold">📞 実戦コックピット V3（リアクティブ完全版）</h1>
